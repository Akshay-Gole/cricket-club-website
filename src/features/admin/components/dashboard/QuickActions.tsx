...
function QuickActions() {
  return (
    <section className="rounded border border-white/[0.1] bg-[#161616] p-5 shadow-[0_14px_44px_rgba(0,0,0,0.22)]">
      <div className="mb-4">
      ...
      <div className="grid grid-cols-1 gap-3 min-[641px]:grid-cols-2 min-[1025px]:grid-cols-1">
        {quickActions.map(action => (
          <Link
            key={action.label}
            to={action.to}
            className={`group rounded border border-white/[0.1] bg-[#202020]/70 p-4 transition-all duration-300 hover:bg-[#252525] ${toneClasses[action.tone]}`}
          >
