function FixturesHeader() {
  return (
    <div className="relative overflow-hidden px-5 sm:px-7 lg:px-12 pt-10 sm:pt-12 lg:pt-14">
      ...
      <div className="relative">
        ...
        <h1 className="font-display text-white text-[44px] sm:text-[56px] lg:text-[84px] leading-[0.9] tracking-[2px]">
          Fixtures &amp;
          <br />
          Results
        </h1>
        <div
          className="font-display text-[44px] sm:text-[56px] lg:text-[84px] leading-[0.9] tracking-[2px] -mt-1.5 mb-8 sm:mb-9 text-transparent pointer-events-none [-webkit-text-stroke:0.5px_rgba(201,168,76,0.1)]"
          aria-hidden="true"
        >
          Fixtures &amp;
          <br />
