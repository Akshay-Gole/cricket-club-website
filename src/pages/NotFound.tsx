...
function NotFound() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden px-5 py-10 text-center min-h-[calc(100vh-72px)]">
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_80%_55%_at_50%_88%,rgba(26,92,46,0.16)_0%,transparent_70%)]" />

      {/* Ghost 404 watermark — huge faint outlined text behind everything */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none font-['Bebas_Neue'] text-[clamp(180px,28vw,320px)] leading-none whitespace-nowrap tracking-[8px] text-transparent [-webkit-text-stroke:1px_rgba(201,168,76,0.3)]">
        404
      </div>
      {/* ANIMATION SCENE */}
      ...
      <div className="relative z-[2]">
        ...
        <div className="flex items-center justify-center gap-3 font-['Barlow_Condensed'] text-[14px] min-[641px]:text-[16px] font-bold tracking-[4px] uppercase text-[#c9a84c] mb-[10px] before:content-[''] before:w-6 before:h-px before:bg-[#c9a84c] after:content-[''] after:w-6 after:h-px after:bg-[#c9a84c]">
          Error 404 : Page Not Found
        </div>

        {/* Headline */}
        <h1 className="font-['Bebas_Neue'] text-[clamp(52px,8vw,92px)] leading-[0.92] tracking-[2px] text-[#f5f5f0] mb-[6px]">
          BOWLED <span className="text-[#c9a84c]">OUT.</span>
        </h1>

        {/* Sub-headline */}
        <div className="font-['Bebas_Neue'] text-[clamp(18px,3vw,32px)] tracking-[3px] text-[#2d8a47] mb-[18px]">
        ...
        {/* Score display */}
        <div className="inline-flex items-center bg-[#161616] border-[0.5px] border-[rgba(255,255,255,0.06)] mb-6 overflow-hidden">
          {/* You */}
          <div className="px-[22px] py-[10px]">
            ...
            <div className="font-['Bebas_Neue'] text-[28px] text-[#c9a84c] leading-none">
              0 / 1
            </div>
          </div>
          ...
          <div className="px-[22px] py-[10px]">
            ...
            <div className="font-['Bebas_Neue'] text-[28px] text-[#f5f5f0] leading-none">
              1 / 0
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 items-center justify-center flex-wrap">
          <NavLink
            to={ROUTES.HOME}
            className="font-['Barlow_Condensed'] text-[12px] font-bold tracking-[3px] uppercase text-[#0a0a0a] bg-[#c9a84c] px-[34px] py-[13px] rounded-[2px] no-underline transition-colors duration-200 hover:bg-[#f0c96a]"
          >
            Back to Home →
          </NavLink>
          <NavLink
            to={ROUTES.FIXTURES}
            className="font-['Barlow_Condensed'] text-[12px] font-bold tracking-[3px] uppercase text-[#8a8a7e] bg-transparent border-[0.5px] border-[rgba(255,255,255,0.06)] px-[26px] py-[13px] rounded-[2px] no-underline transition-all duration-200 hover:text-[#f5f5f0] hover:border-[rgba(255,255,255,0.2)]"
          >
            View Fixtures
          </NavLink>
        </div>
